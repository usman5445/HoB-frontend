...
const FeaturedProducts = () => {
  ...
  return (
    <>
      <div
        className="FPcontainer d-flex  justify-content-center align-items-center flex-column "
        style={{ width: "100vw", overflowX: "hidden" }}
      >
        <div
          className="FPheading d-flex  justify-content-center align-items-center flex-row mx-2 "
        ...
        <button
          type="button"
          className="btn btn-primary VIEWALl "
          style={{
            background: "black",
            marginTop: "1.3rem",
            borderColor: "white",
        ...
        <div className="hustlerContainer my-5">
          <div className="hangerimg">
            ...
            />
            <div
              className="hustlerblackcont d-flex   align-items-center "
              style={{
                height: "8vh",
                width: "100vw",
                background: "black",
            ...
            <div className="andcont">
              <div
                className="hustleryellowcont my-2 d-flex  justify-content-center align-items-center"
                style={{
                  height: "8vh",
                  background: "#FFDF05",
                  color: "#005CFF",
              ...
              <div
                className="hustlerredcont my-2 d-flex  align-items-center"
                style={{
                  height: "8vh",
                  background: "#F90000",
                  color: "white",
        ...
        <div className="recycledContainer  d-flex  justify-content-center align-items-center flex-row">
          <div
            className="leftrecycledContainer d-flex  justify-content-center align-items-center flex-column "
            style={{ height: "100%" }}
          >
            <div className="cardrecycled d-flex  justify-content-center align-items-center flex-column">
              <img src={tshirt} alt="..." />
              <div className="recycleddetails ">
                <span className="quantity ml-5" id="quantity">
                  500
                </span>
          ...
          <div
            className="rightrecycledContainer d-flex  justify-content-center align-items-center"
            style={{ height: "100%" }}
          >
            <div className="cardrecycled my-5 d-flex  justify-content-center align-items-center flex-column card1">
              <img src={drop} alt="..." />
              <div className="recycleddetails ">
            ...
            <div className="cardrecycled my-5 d-flex  justify-content-center align-items-center flex-column card2">
              <img src={polygon} alt="..." />
              <div className="recycleddetails ">
        ...
        <div className="position-relative marquee-container d-none d-sm-block mt-5">
          <div className="perfectdrip  d-flex  justify-content-center align-items-center mt-2">
            <span style={{ fontSize: "1.3rem" }}>
              the perfect <b>DRIP</b> &nbsp; <img src={smilelogo} alt="..." />
              &nbsp;{" "}
            </span>
            <span style={{ fontSize: "1.3rem" }}>
              the perfect <b>DRIP</b>&nbsp; <img src={smilelogo} alt="..." />
        ...
        <div className="shopUnboxContainer d-flex  justify-content-center align-items-center flex-column my-3">
          ...
          <div className="shopUnboxDescription-1">
            Your awaited HOB shipment arrives in <br></br>{" "}
            <p className="shopdescenv">
              100 % ENVIRONMENTAL FRIENDLY PACKETS with PLANTABLE SEED TAGS.
            </p>
            <div className="my-3">
              Yes, you got it right,{" "}
              <b> just tear &gt; sow &gt; water &gt; & let it grow.</b>
            </div>
          </div>
        </div>
        ...
        <div
          className="magazineContainer  d-flex  justify-content-center align-items-center flex-column"
          style={{ height: "53rem", width: "100vw", overflow: "hidden" }}
        >
          <div className="magazinecont">
            <div className="magazineheadingcont">
              <div className="magazineHeading">HOB MAGAZINE</div>
              <div className="magazineHeading p2" style={{ color: "white" }}>
                HOB MAGAZINE
              </div>
              <div className="magazineHeading">HOB MAGAZINE</div>
            </div>

            <div className="magazinecard mt-2">
              ...
              <div className="card-body d-flex  justify-content-center align-items-center flex-column">
                ...
                >
                  More clothes in landfills than on the body. Why?
                </h5>
                <p className="card-text" style={{ text_Align: "center" }}>
                  The more garments we purchase, the less we utilise them,
                  resulting in rising fashion waste. As a result, the apparel
                  and textile sector has risen to third spot on the list of the
                  world's worst...
                </p>
                <button
                  type="button"
        ...
        <div className="smilelogoContainer d-flex  justify-content-center align-items-center flex-row mt-2 mb-5">
